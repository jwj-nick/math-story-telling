...
상위 frame: [INTEGRATED_PLAN](../../../11_video_gen_process/00_charter/INTEGRATED_PLAN.md) §5.0 skill chain / §5.3 단계 [서사] / §8 결정 1·2.
...
본 v0.1 body 는 **exp-002 STEP 1 시범 실행의 reverse-engineering** 으로 작성됨 (2026-05-25). 시범 결과: [`../../../11_video_gen_process/40_experiments/exp-002-build-unit01/1-narrative.md`](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/1-narrative.md). 시범에서 실제로 한 동작을 정형화.
...
- ⭐ **직업 ≠ 설명 언어 혼동 금지 (unit-02 학습, 2026-05-30)**: 인물이 개념을 *설명한 비유·언어* 를 그의 *직업·활동* 으로 서술하지 말 것. 예: 브라마굽타는 천문학자였고 음수를 *빚/재산* 으로 *설명* 했을 뿐 — "천문 계산 → 회계 필요" 식 인과(그가 회계도 했다는 암시)는 비약. 올바른 연결 = "그는 0보다 작은 수가 필요했고, 그걸 누구나 아는 빚/재산으로 *설명* 했다". 인물의 *발견* 과 그가 쓴 *설명 도구* 를 분리 서술. (다음 단계 [나레이션] dialog 가 이 인과를 그대로 운반하므로 서사에서 차단 필수.)
...
본 시범 호출 예시: [`../../../11_video_gen_process/40_experiments/exp-002-build-unit01/1-narrative.md`](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/1-narrative.md).

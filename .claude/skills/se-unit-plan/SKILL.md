---
name: se-unit-plan
description: 단원 파이프라인을 킥오프한다. chatlog 파일을 생성하고 Phase 1~5 체크리스트를 세팅. 호출 예시 — "/se-unit-plan unit02 정수와유리수", "/se-unit-plan unit03".
---

# se-unit-plan — 단원 파이프라인 킥오프 스킬

## 인자 형태
```
/se-unit-plan unit02 정수와유리수
/se-unit-plan unit03
```
...
## Phase 1: 개념 (축 A)
- [ ] 40_BaseDocs/NN_단원명/ 검수 (/se-concept-review)
- [ ] Nick과 개념 범위·깊이 협의

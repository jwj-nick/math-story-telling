---
name: se-math-figure
description: 수학 그래프를 네이티브 HTML로 렌더링한다. 정적 SVG 또는 JSXGraph 인터랙티브 보드를 생성. 호출 예시 — "/se-math-figure Q3", "/se-math-figure unit04 좌표평면".
---

# se-math-figure — 수학 그래프 네이티브 렌더링 스킬

## 언제 사용하나

`/se-math-figure Q3` 처럼 호출. 오답노트 또는 개념 탐구 앱의 그래프를 Native HTML로 생성.

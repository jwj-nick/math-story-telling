...
> **단일 진입점**: [SKILL.md](./SKILL.md) / 프롬프트 = [5-image_prompts.md](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/5-image_prompts.md)
...
> 본 프로젝트 기본 프롬프트 = [5-image_prompts.md](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/5-image_prompts.md) (도구 무관 자연어 + STYLE/CHAR 블록).

...
상위 frame: [INTEGRATED_PLAN](../../../11_video_gen_process/00_charter/INTEGRATED_PLAN.md) §5.0 skill chain / §5.5.4 단계 [영상 4] 모션.
...
본 v0.1 body 는 **exp-002 STEP 6 시범**으로 작성됨 (2026-05-29). 시범 결과: [`../../../11_video_gen_process/40_experiments/exp-002-build-unit01/6-motion-config.json`](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/6-motion-config.json) (8 scene, 140.27s).
...
본 시범 호출 예시: [`../../../11_video_gen_process/40_experiments/exp-002-build-unit01/6-motion-config.json`](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/6-motion-config.json).

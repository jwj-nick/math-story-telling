...
상위 frame: [INTEGRATED_PLAN](../../../11_video_gen_process/00_charter/INTEGRATED_PLAN.md) §5.0 skill chain / §5.4 단계 [스토리] / §8 결정 1·2 / §5.1.2 A3·A4·A6.
...
본 v0.1 body 는 **exp-002 STEP 2 시범 실행의 reverse-engineering** 으로 작성됨 (2026-05-25). 시범 결과: [`../../../11_video_gen_process/40_experiments/exp-002-build-unit01/2-story-seed.md`](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/2-story-seed.md).
...
본 시범 호출 예시: [`../../../11_video_gen_process/40_experiments/exp-002-build-unit01/2-story-seed.md`](../../../11_video_gen_process/40_experiments/exp-002-build-unit01/2-story-seed.md).

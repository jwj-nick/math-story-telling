...
상위 frame: [INTEGRATED_PLAN](../../00_charter/INTEGRATED_PLAN.md) §5.0 skill chain.
...
본 v0.1 body 는 **exp-002 STEP 5 시범** 으로 작성됨 (2026-05-28). 시범 결과: [`../../40_experiments/exp-002-build-unit01/5-image_prompts.md`](../../40_experiments/exp-002-build-unit01/5-image_prompts.md).
...
본 시범 호출 예시: [`../../40_experiments/exp-002-build-unit01/5-image_prompts.md`](../../40_experiments/exp-002-build-unit01/5-image_prompts.md).

...
본 v0.2 body 는 **exp-002 STEP 4 시범 + Nick redirect 2 (dialog 형식)** 으로 작성됨 (2026-05-26). 시범 결과 (예정): [`../../40_experiments/exp-002-build-unit01/4-narration.{txt,xml,jsonl,mp3}`](../../40_experiments/exp-002-build-unit01/).

**시스템 톤·구조 결정 (v2 dialog)**: [`../../00_charter/TONE_STRUCTURE.md`](../../00_charter/TONE_STRUCTURE.md) (결정 10 v2 — 2 화자 dialog: Q 청소년 + A 대학원생).
...
본 시범 호출 예시: [`../../40_experiments/exp-002-build-unit01/4-narration.{txt,xml,mp3}`](../../40_experiments/exp-002-build-unit01/).

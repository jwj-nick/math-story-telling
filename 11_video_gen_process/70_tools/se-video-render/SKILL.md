...
상위 frame: [INTEGRATED_PLAN](../../00_charter/INTEGRATED_PLAN.md) §5.0 skill chain. 심화 가이드: [`../../20_step_guides/07_step7_render.md`](../../20_step_guides/07_step7_render.md).
...
본 v0.1 body 는 **exp-002 STEP 7 시범** 으로 작성됨 (2026-05-29). 시범 결과: 검증 성공한 S1 클립(1280×720, 18.24s) 기반 FFmpeg zoompan+drawtext+fade 파이프라인. 클립: [`../../40_experiments/exp-002-build-unit01/clips/`](../../40_experiments/exp-002-build-unit01/clips/), 자막 textfile: `captxt/`.
...
본 시범 호출 예시: [`../../40_experiments/exp-002-build-unit01/clips/`](../../40_experiments/exp-002-build-unit01/clips/) (S1 검증 1280×720/18.24s).

#!/usr/bin/env python3
# synth.py — unit-04 알콰리즈미(secondary) ElevenLabs 합성 (voice-pool §0.6 절차 재현)
# turn별 합성 → post-process(volume + alimiter) → concat(silence) → 4-narration.mp3
# voice: Q=Mina(없음) / A=Kyle(+3.8dB). (u04 디오판토스 Mike/Kanna, u03 알콰리즈미 Kanna/Mike 와 다름)

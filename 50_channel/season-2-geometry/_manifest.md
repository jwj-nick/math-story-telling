...
- 2026-05-31: **unit-11 done** (플라톤, 다섯, Kanna/Kyle, 188s). 정다면체 5종·오일러·5원소·회전체 대조·케플러. 유클리드+케플러 동시 재등장. 학습 R39(밀도높은 서사는 ≈1650자로 압축)·R40(diagram 강제구문 확정)·R41(개수·배치 명시). 다음=u12 아르키메데스(겉넓이·부피).

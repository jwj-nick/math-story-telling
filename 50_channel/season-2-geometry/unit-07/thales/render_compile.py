#!/usr/bin/env python3
# render_compile.py — unit-07 탈레스 / 6-motion-config.json → scene 클립(zoompan+drawtext+fade) → concat → 7-raw.mp4
# se-video-render §CL/CC 검증 패턴 자동화 (v0.2 컴파일러). config-driven — euclid 템플릿과 동일 로직.

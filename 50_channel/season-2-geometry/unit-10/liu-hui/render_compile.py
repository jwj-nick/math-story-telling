#!/usr/bin/env python3
# render_compile.py — unit-10 류후이. 6-motion-config.json → scene 클립(zoompan+drawtext+fade) → concat → 7-raw.mp4
# se-video-render §CL/CC 검증 패턴 자동화 (v0.2 컴파일러). 아르키메데스 템플릿 동일 로직.

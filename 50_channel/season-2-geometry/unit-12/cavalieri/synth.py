#!/usr/bin/env python3
# synth.py — unit-12 카발리에리 ElevenLabs 합성 (voice-pool §0.6 절차 재현)
# turn별 합성 → post-process(volume) → concat(silence) → 4-narration.mp3
# voice: Q=Kanna(여, speed 1.15, vol 0) / A=Mike(남, speed 1.0, vol +8dB)  ← 아르키메데스와 성별 교차
...
# post-process volume per voice (voice-pool §0.2): Mike +8dB, Kyle +3.8dB, Mina/Kanna 없음

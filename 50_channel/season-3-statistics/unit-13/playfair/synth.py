#!/usr/bin/env python3
# synth.py — unit-13 플레이페어 ElevenLabs 합성 (voice-pool §0.6 절차 재현)
# voice: Q=Mina(speed 1.15, no post) / A=Kyle(+3.8dB, alimiter)  ← 나이팅게일(Kanna+Mike)과 다른 pairing
...
# post-process volume per voice (voice-pool §0.2): Kyle +3.8dB, Mike +8dB, Q 없음
